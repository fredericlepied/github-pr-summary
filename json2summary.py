...
def create_summary(data):
    ...
    prompt = f'You are an experienced software developer. You will act as a reviewer for a GitHub Pull Request {url} titled "{title}" with the following description:\n"{description}"\n\nand code change:\n{code}\n\n.Please summarize the key changes from the title, description and code in a single sentence with this format: [<title>](<url): <summary>. Do not use the words Pull Request in the summary.'
